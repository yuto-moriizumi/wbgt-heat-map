...
export const metadata: Metadata = {
  title: "日本暑さマップ",
  description:
    "Real-time WBGT (Wet Bulb Globe Temperature) heat map for Japan. Monitor heat stress levels and heat-related health risks across Japanese prefectures.",
  keywords: [
    "WBGT",
    "heat map",
    "Japan",
  ...
  twitter: {
    ...
    title: "WBGT Heat Map - Japan Wet Bulb Globe Temperature",
    description:
      "Real-time WBGT heat map for Japan. Monitor heat stress levels across Japanese prefectures.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
